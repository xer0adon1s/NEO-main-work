...
| 4.9 | AI conductor (Tier A bundle + sequencing + hooks) | [~] **prototyped, v0.6** — see FEATURE-STATUS.md |
...
7. ~~**Tier 4+** — not started / deferred~~ **Tier 4+ prototyped, v0.6** — see `FEATURE-STATUS.md` / `SCOPE-STATUS.md`
